...
def parse_docx_structure(docx_path, out_json_path):
    ...
    with zipfile.ZipFile(docx_path, 'r') as zip_ref:
        ...
        for child in body:
            ...
            elif tag == 'tbl': # Table (we can extract simple table text if needed)
                table_cells = []
        ...
        # Write layout sequence to a file
        out_txt_path = out_json_path.replace('.json', '_layout.txt')
...
if __name__ == "__main__":
    docx_path = r"C:\Users\Admin\Documents\PRODUCTO DIGITAL\BONUS 3 TÚ COMO ROSTRO DE MARCA\BONUS 3 TÚ COMO ROSTRO DE MARCA.docx"
    out_json_path = r"C:\Users\Admin\Documents\PRODUCTO DIGITAL\bonus_3_layout.json"
    parse_docx_structure(docx_path, out_json_path)
